...
rot_drop_rate = 0.1
layer_drop_rate = 0.1
drop_rate_tot = rot_drop_rate*layer_drop_rate
...
fname_train_acc = f'Results/Cross_Entropy_Dropout/train_acc_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{drop_rate_tot}droprate_{t_size}trainsize_CE.txt'
...
fname_test_acc = f'Results/Cross_Entropy_Dropout/test_acc_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{drop_rate_tot}droprate_{t_size}trainsize_CE.txt'
...
fname_train_cost = f'Results/Cross_Entropy_Dropout/train_cost_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{drop_rate_tot}droprate_{t_size}trainsize_CE.txt'
...
fname_test_cost = f'Results/Cross_Entropy_Dropout/test_cost_{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_{seed}seed_{drop_rate_tot}droprate_{t_size}trainsize_CE.txt'
...
#fname_resources = f'Results/Resources/{layers}layers_batchsize{batch_size}_stocstep{stocastic_step}_CE_resources.txt'
#with open(fname_resources, 'w') as f:
